    ...
    return (
        <article className='mt-3 mx-3 columns is-family-code is-size-6 is-size-7-mobile'>
            <div className='column has-background-link-light has-text-left m-1'>
                <p className="mb-1">At the moment of this writing, this app is designed specifically as an educational tool for those who wish to learn about the cryptocurrency market.</p>
